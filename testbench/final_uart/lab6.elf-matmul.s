...
.Ltext0:
	...
	.file 0 "/home/ponponri/Desktop/shared_folder/SoC_Final_UART_SYN/testbench/final_uart" "matmul.c"
	.globl	A
	.data
	.align	2
	.type	A, @object
...
.L5:
	...
	sw	a5,-28(s0)
.L4:
	.loc 1 15 15 discriminator 1
	lw	a4,-28(s0)
	li	a5,3
	ble	a4,a5,.L5
	.loc 1 17 13 discriminator 2
	lw	a5,-20(s0)
	slli	a4,a5,2
	.loc 1 17 17 discriminator 2
	lw	a5,-24(s0)
	add	a5,a4,a5
